...
impl Rectangle {
    // self which is the instance which the method is being called
    fn area(&self) -> u32 {
    ...
    fn myself(self: &Rectangle) {
        // &self is shorthand for self : &Self and &Self is an alias for the current type
        //                         // in this case &Rectangle
        println!(
            "Look at me height={} width={} area={}",
            self.height,
            self.width,
            self.area()
        );
...
impl Rectangle {
    fn square(size: u32) -> Rectangle {
        // associated function, this is not a method, they are usually used as a "constructor"
        Rectangle {
            width: size,
            height: size,
        }
    ...
    fn square_self(size: u32) -> Self {
        // using the Self alias as a type, this is not a method
        Self {
            width: size,
            height: size,
        }
